...
<div class="main">
    ...
    <div class="lable">
        ...
        <input id="acticity_create_name" type="text" required="" name="activityName" class="text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '活动名称';}">
    </div>
    <br/>
    <div class="lable">
    ...
    <div class="lable activity-date">
        ...
        <input name="startTime" size="16" type="text" value="2016-11-15 14:45" readonly class="form_datetime">
    </div>
    <div class="lable activity-date">
        <label>请选择活动结束时间</label>
        <input name="endTime" size="16" type="text" value="2016-11-15 14:45" readonly class="form_datetime">
    </div>
    <div class="lable">
        <label>请输入活动描述</label>
